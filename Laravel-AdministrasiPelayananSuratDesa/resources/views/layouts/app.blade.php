...
<body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="/home" style="color: #2d2d2d">
          PELAYANAN SURAT
        </a>
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Pelayanan Surat Menyurat Desa 
            <a href="https://opensid.my.id/" target="_blank">XYZ</a>. © {{date('Y')}}</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
